...
原版通用通信协议不再作为当前固件说明的一部分，但协议定义已原样保留在 `firmware/LEGACY_PROTOCOL_REFERENCE.md`，仅用于和当前底盘协议做对照，不参与当前活跃固件说明。
...
- `firmware/MOTOR_MIGRATION_PROJECT.md`
- `firmware/docx/formal_protocol_status.md`
- `firmware/upper_computer/python_programs/README.md`

原版通用 `SERVO` / `POSE` 协议定义保留在：

- `firmware/LEGACY_PROTOCOL_REFERENCE.md`

## 构建环境

- **IDE**: `Keil MDK-ARM uVision 5`
- **编译器**: `ARMCC 5.05 update 1`
- **工程文件**: `firmware/MDK-ARM/wheeled_leg_robot_f407.uvprojx`
- **目标名**: `wheeled_leg_robot_f407`

参考命令：

```powershell
D:\Keil_v5\UV4\uVision.com -r firmware\MDK-ARM\wheeled_leg_robot_f407.uvprojx -t wheeled_leg_robot_f407 -o firmware\MDK-ARM\keil_rebuild.log
```

## 文档索引

- **当前固件构建与运行说明**: `firmware/MOTOR_MIGRATION_PROJECT.md`
- **正式二进制协议状态记录**: `firmware/docx/formal_protocol_status.md`
- **上位机脚本与串口联调说明**: `firmware/upper_computer/python_programs/README.md`
- **原版通用协议对照保留**: `firmware/LEGACY_PROTOCOL_REFERENCE.md`
